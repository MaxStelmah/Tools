        ...
        for i in range(0, numElementsList1):
            for j in range(0, numElementsList2):
                if listX1[i] == listX2[j]:
                    diff = ImagesLib.compareTwoImages(listImg1[i], listImg2[j]) # compare images
...
#--- add a track 1------------------------------
folderForScanningImages = "D:/autovision_v1/"                                           # 1 Address of the first TimeTrack

track1 = TimeTrack(1, 0.2)
pLog1 = ParsedLog.ParsedLog()
...
folderForScanningImages = "D:/autovision_v2/"                                           # 2 Addres of the second TimeTrack

track2 = TimeTrack(1, 1.2)
pLog2 = ParsedLog.ParsedLog()
